...
`pnpm --filter api test` — зелёные по вашим файлам. Тесты пишет `test-engineer`, но если
меняете существующий тест из-за смены поведения — почините его. Не коммитьте и не пушьте
сами (если вы тиммейт — сообщите лиду о готовности; если субагент — верните итог
вызвавшему). Не трогайте файлы вне вашей задачи.
