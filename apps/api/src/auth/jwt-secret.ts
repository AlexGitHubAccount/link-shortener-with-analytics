...
//
// Security review (Stage 4, security-reviewer subagent) flagged that both sides previously
// fell back to a shared hardcoded string when JWT_SECRET was unset: if that env var were ever
