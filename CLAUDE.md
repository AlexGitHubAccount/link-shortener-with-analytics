...
**Релиз `v1.0.0`** (2026-09-01) — тег + GitHub Release, `main` зелёный в CI. Все 8 этапов + Tier 0 production-подготовка закрыты. Что входит и известные ограничения (CD не настроен, Google OAuth требует реальных кредов) — секция `## [1.0.0]` в `CHANGELOG.md`.
